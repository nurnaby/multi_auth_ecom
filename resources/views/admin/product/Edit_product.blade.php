...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <hr />
                <form action="{{ route('product.update') }}" id="myForm" method="post">
                    @method('PUT')
                    @csrf
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="form-select" name="vendor_id" id="inputVendor">
                                                ...
                                                @foreach ($vendors as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $item->id == $product->vendor_id ? 'selected' : '' }}>
    ...
    <div class="page-content">
        <div class="card p-4">
            ...
            <hr />
            <form action="{{ route('product.main_img.update') }}" id="myForm" method="post"
        ...
        <div class="card p-4">
            ...
            <div class="card-body">
                <table class="table mb-0 table-striped">
                    ...
                    <tbody>
                        <form action="{{ route('product.multi_image.update') }}" id="myForm" method="post"
                            enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            @foreach ($multiImage as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        <input type="submit" class="btn btn-primary px-4" value="Save Change" />
                                        <a href="{{ route('product.multi_img.delete', $item->id) }}"
