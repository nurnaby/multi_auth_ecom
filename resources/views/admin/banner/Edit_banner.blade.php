            ...
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('banner.update') }}" id="myForm" method="post"
                                    enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    <input type="hidden" class="form-control" name="banner_id"
                                        value="{{ $banner_data->id }}">
                                    <input type="hidden" class="form-control" name="banner_img"
                                        value="{{ $banner_data->banner_url }}">
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="file" class="form-control" id="image" name="banner_img" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                        ...
                                        <div class=" col-sm-9 text-secondary">
                                            <img id="showImage" src="{{ asset($banner_data->banner_img) }}" alt="Admin"
