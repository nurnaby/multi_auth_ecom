            ...
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('slider.update') }}" id="myForm" method="post"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class=" form-group col-sm-9 text-secondary">
                                            ...
                                            <input type="text" class="form-control" name="slider_title"
                                                value="{{ $slider_data->slider_title }}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class=" col-sm-9 text-secondary">
                                            <img id="showImage" src="{{ asset($slider_data->slider_img) }}" alt="Admin"
